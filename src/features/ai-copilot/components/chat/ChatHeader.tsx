  ...
  return (
    <div className="flex items-center justify-between p-4 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white shrink-0">
      ...
      <div className="flex items-center gap-1">
        ...
        {/* Só o ícone, sem rótulo: com o texto ao lado o cabeçalho ficava apertado e os
            botões quebravam para uma segunda linha. O ícone de "novo" já não se
            confunde com "apagar" como a lixeira antiga, e o `title` continua a servir
